% Document Setup
\documentclass[10pt,letterpaper]{paws}
% See Figure 1 in http://texdoc.net/texmf-dist/doc/latex/geometry/geometry.pdf
\geometry{top=1cm,bottom=1cm,left=1cm,right=16cm,marginparwidth=14cm,marginparsep=1cm}
...
\definecolor{Purple}{HTML}{673ab7}
